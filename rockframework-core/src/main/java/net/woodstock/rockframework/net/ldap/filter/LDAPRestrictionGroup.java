...
public abstract class LDAPRestrictionGroup extends LDAPRestriction {
	...
	public static LDAPRestrictionGroup and() {
		LDAPRestrictionGroup restriction = new LDAPRestrictionAnd();
		return restriction;
	}

	public static LDAPRestrictionGroup or() {
		LDAPRestrictionGroup restriction = new LDAPRestrictionOr();
		return restriction;
	}

	public abstract void add(LDAPRestriction restriction);
