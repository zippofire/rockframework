...
public class TokenConverterException extends RuntimeException {

	private static final long	serialVersionUID	= 2649806464329933776L;

	public TokenConverterException(String message, Throwable throwable) {
	...
	public TokenConverterException(Throwable throwable) {
		super(throwable);
	}
