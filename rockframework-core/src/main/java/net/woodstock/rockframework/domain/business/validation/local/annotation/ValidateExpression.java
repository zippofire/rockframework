...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorExpression;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorExpression.class)
public @interface ValidateExpression {

	String[] expression();

	boolean useParent() default false;
