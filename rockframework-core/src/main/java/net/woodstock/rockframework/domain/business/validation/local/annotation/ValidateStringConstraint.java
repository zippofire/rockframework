...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorStringConstraint;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorStringConstraint.class)
public @interface ValidateStringConstraint {
