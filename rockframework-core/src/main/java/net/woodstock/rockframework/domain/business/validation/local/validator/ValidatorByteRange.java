...
public class ValidatorByteRange extends AbstractObjectValidator {
	...
	private String getErrorMessage(ValidateByteRange annotation, String name) {
		return this.getMessage(ObjectValidator.MESSAGE_FIELD_ERROR_RANGE, name, new Byte(annotation.min()),
				new Byte(annotation.max()));
	}
