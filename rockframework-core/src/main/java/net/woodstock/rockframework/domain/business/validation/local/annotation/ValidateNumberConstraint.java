...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorNumberConstraint;
import net.woodstock.rockframework.utils.StringUtils;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorNumberConstraint.class)
public @interface ValidateNumberConstraint {
