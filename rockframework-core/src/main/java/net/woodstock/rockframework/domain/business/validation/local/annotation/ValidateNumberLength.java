...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorNumberLength;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorNumberLength.class)
public @interface ValidateNumberLength {
