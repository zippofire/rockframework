...
@Aspect
public class AnnotedDeleteAdvice {

	@Before(value = "target(net.woodstock.rockframework.persistence.DAO) && execution(* delete(..)) && args(pojo)")
	public void validate(Pojo pojo) throws ValidationException {
		ObjectValidator.validate(pojo, Operation.DELETE);
	}
