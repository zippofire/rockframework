...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorByteConstraint;
import net.woodstock.rockframework.utils.StringUtils;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorByteConstraint.class)
public @interface ValidateByteConstraint {
