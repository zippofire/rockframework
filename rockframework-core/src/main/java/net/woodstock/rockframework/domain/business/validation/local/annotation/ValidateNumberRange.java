...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorNumberRange;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorNumberRange.class)
public @interface ValidateNumberRange {
