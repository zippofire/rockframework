...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorDoubleConstraint;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorDoubleConstraint.class)
public @interface ValidateDoubleConstraint {
