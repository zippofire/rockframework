...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorIntConstraint;
import net.woodstock.rockframework.utils.StringUtils;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorIntConstraint.class)
public @interface ValidateIntConstraint {
