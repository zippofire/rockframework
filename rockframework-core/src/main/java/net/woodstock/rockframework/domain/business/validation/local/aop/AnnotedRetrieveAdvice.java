...
@Aspect
public class AnnotedRetrieveAdvice {

	@Before(value = "target(net.woodstock.rockframework.persistence.DAO) && execution(* retrieve(..)) && args(pojo)")
	public void validate(Pojo pojo) throws ValidationException {
		ObjectValidator.validate(pojo, Operation.RETRIEVE);
	}
