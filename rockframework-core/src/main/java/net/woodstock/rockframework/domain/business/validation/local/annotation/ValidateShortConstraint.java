...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorShortConstraint;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorShortConstraint.class)
public @interface ValidateShortConstraint {
