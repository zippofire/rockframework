...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorShortRange;
import net.woodstock.rockframework.utils.StringUtils;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorShortRange.class)
public @interface ValidateShortRange {
