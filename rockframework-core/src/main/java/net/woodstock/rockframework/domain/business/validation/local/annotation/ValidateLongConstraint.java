...
import net.woodstock.rockframework.domain.business.validation.local.validator.ValidatorLongConstraint;

@Retention(value = RetentionPolicy.RUNTIME)
@Target(value = ElementType.FIELD)
@Validate(validator = ValidatorLongConstraint.class)
public @interface ValidateLongConstraint {
