...
public final class HSSFSpreadsheetDocumentReader extends AbstractSpreadsheetDocumentReader {

	private static SpreadsheetDocumentReader	instance	= new HSSFSpreadsheetDocumentReader();

	private HSSFSpreadsheetDocumentReader() {
		super();
	}
	...
	public static SpreadsheetDocumentReader getInstance() {
		return HSSFSpreadsheetDocumentReader.instance;
	}
