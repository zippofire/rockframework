...
public class HibernateFlushProblemPreUpdateListener implements PreUpdateEventListener {
	...
	private boolean isCascade(final PropertyDescriptor propertyDescriptor) {
