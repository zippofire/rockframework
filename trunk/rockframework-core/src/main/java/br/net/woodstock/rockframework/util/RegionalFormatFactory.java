...
public abstract class RegionalFormatFactory<T extends Format> extends FormatFactory<T> {

	private static final String	SEPARATOR	= "@";

	public RegionalFormatFactory() {
		super();
	}

	protected boolean containsOnCache(final String pattern, final Locale locale) {
		String key = pattern + RegionalFormatFactory.SEPARATOR + locale;
